...
// Release signing: create android/key.properties (see mobile/README.md).
// Falls back to debug signing so `flutter build apk` always succeeds for
// direct family installs.
...
android {
    ...
    defaultConfig {
        applicationId = "net.el3ktra.aphasia_talk"
        // record (dictation) requires 23+; keeps behavior consistent across devices.
